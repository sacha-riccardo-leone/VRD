/**
 * Les neuf domaines de VRD, dans l'ordre du portfolio.
 *
 * Module SANS "use client" à dessein : la page serveur et l'ennéagone client
 ...
 * jamais réécrits. Trois domaines n'ont aucune copie sur le site actuel
 * (sprinkler, MCR, sécurité incendie) : leur teaser vaut null et la carte
 * affiche la réserve.
 */
export type Discipline = {
  ...
  chips: string[];
  /**
   * Responsable du domaine, d'après l'organigramme VRD 2026. Chaîne libre et
   * non un identifiant de personne : le site n'expose aucune fiche nominative
   * — ni portable ni courriel — et l'initiale suffit à la mention affichée.
   */
  responsable: string;
};
...
export const DISCIPLINES: Discipline[] = [
  ...
  },
  {
    ...
    teaser: null, // TODO: teaser — aucune copie sécurité incendie sur le site actuel.
    chips: [],
    responsable: "D. Rodrigues",
  },
];
