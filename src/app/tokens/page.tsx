...
const ON_PAPER: Pair[] = [
  ...
  { fg: "#505050", bg: "#f5f5f5", use: "--ink-muted sur --paper", limit: "texte secondaire" },
  { fg: "#7f7f7f", bg: "#f5f5f5", use: "--rule-strong sur --paper", limit: "séparateurs porteurs de sens" },
  {
    fg: "#d0d0d0",
    bg: "#f5f5f5",
    use: "--rule sur --paper",
...
const ON_DARK: Pair[] = [
  ...
  { fg: "#aeaeae", bg: "#1c1c1c", use: "--on-dark-muted sur --dark", limit: "texte secondaire" },
